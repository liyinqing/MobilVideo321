package atguigu.com.mobilvideo321.view;
...
/**
 * 作者：李银庆 on 2017/5/25 11:12
 */
public class Tetle extends LinearLayout implements View.OnClickListener {
    private final Context context;
    private TextView tv_sousuo ;
    private RelativeLayout rl_game;
    private ImageView iv_record ;

    public Tetle(Context context, AttributeSet attrs) {
        super(context, attrs);
